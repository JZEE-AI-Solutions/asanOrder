...
const EnhancedCreateFormModal = ({ tenants, defaultTenantId, onClose, onSuccess }) => {
  ...
  return (
    <div className="fixed inset-0 bg-gray-600 bg-opacity-50 overflow-y-auto h-full w-full z-50">
      <div className="relative top-4 mx-auto p-5 border w-11/12 max-w-6xl shadow-lg rounded-md bg-white max-h-screen overflow-y-auto">
        <div className="flex justify-between items-center mb-4">
          <h3 className="text-lg font-medium text-gray-900">Create Enhanced Order Form</h3>
          <button
            onClick={onClose}
          ...
          {selectedTenantId && (
            <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
              <div className="flex items-center justify-between mb-4">
                ...
                <button
                  type="button"
                  onClick={addProductSelectorField}
              ...
              <p className="text-sm text-blue-700 mb-4">
                Select products that customers can choose from when filling out this form.
...
export default EnhancedCreateFormModal
